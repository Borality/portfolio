	...
	return (
		<div className="grid max-w-6xl items-stretch gap-8 py-12 lg:grid-cols-2 xl:grid-cols-3">
			{projects.map((project, index) => (
				// biome-ignore lint/suspicious/noArrayIndexKey: static list of characters; using index as key is safe
				<Tilt key={index} rotationFactor={8} isRevese>
					<Card
						key={project.title}
						className="group flex h-full flex-col overflow-hidden transition-all hover:shadow-lg max-w-xl pt-0"
					>
