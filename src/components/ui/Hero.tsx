...
const HeroImage: FC<HeroImageProps> = ({ src }) => (
  <Image
    ...
    className="h-auto w-full max-w-[18rem] rounded-bl-[5rem] rounded-tr-[5rem] md:w-screen md:max-w-[20rem] lg:max-w-[25rem] lg:drop-shadow-[0_0_1rem_#1d82f9] xl:max-w-[31rem]"
  />
);
